...
class Login extends Component{
    ...
    render(){
        return <div className="login">
            ...
            <p className="login_p">
                <a className="login_a1">登录遇到问题</a>
                <a className="login_a2">其他登录方式</a>
            </p>
